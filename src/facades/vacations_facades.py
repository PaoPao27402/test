...
class VacationFacade:
    ...
    def add_vacation(self, vacations_ID, country_ID, vacation_description, start_vacation_date, end_vacation_date, price):
        return self.logic.add_vacation(vacations_ID, country_ID, vacation_description, start_vacation_date, end_vacation_date, price)
    
    def update_vacation(self, vacations_ID, country_ID, vacation_description, start_vacation_date, end_vacation_date, price):
        return self.logic.update_vacation(vacations_ID, country_ID, vacation_description, start_vacation_date, end_vacation_date, price)
